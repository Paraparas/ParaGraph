...
export const transcriptSystemPrompt: string = "Extract time-segmented summaries from meeting transcripts, including topics, timestamps, content, and speaker information."
